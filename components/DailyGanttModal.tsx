...
interface Props {
    ...
    onClose: () => void;
    date: Date;
    schedules: Schedule[]; // Schedules for this specific day
}

export default function DailyGanttModal({ isOpen, onClose, date, schedules }: Props) {
    ...
    // Sort schedules: Working first, then Off, then missing (though missing might not be passed)
    ...
    return (
        <div className="fixed inset-0 bg-black/50 backdrop-blur-sm z-50 flex items-center justify-center p-4 animate-in fade-in duration-200">
            <div className="bg-white dark:bg-zinc-900 rounded-2xl shadow-xl w-full max-w-4xl max-h-[90vh] flex flex-col border border-zinc-100 dark:border-zinc-800">
                    ...
                    <div className="space-y-4">
                        ...
                        {sortedSchedules.length === 0 && (
                            <div className="text-center py-10 text-zinc-400">
                                Niciun program setat pentru această zi.
                            </div>
                        )}
                    </div>
                </div>
